# Generated by Django 4.1.8 on 2023-04-23 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('Demande Ordre de mission', 'OM'), ('Demande de Frais de mission', 'FM')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demand_type', models.CharField(choices=[('Demande Ordre de mission', 'OM'), ('Demande de Frais de mission', 'FM')], max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Transition',
            fields=[
                ...
                ('start_state', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='start_point', to='mission.statedemand')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mission_type', models.CharField(choices=[('Technique', 'TECHNIC'), ('Inspection', 'INSPECT'), ('Management', 'MANAGE'), ('Audit et Contrôle', 'AUDIT')], max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('demand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mission.demand')),
                ('mission_order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mission.missionorder')),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
            fields=[
                ...
                ('direction', models.CharField(choices=[('Retraites', 'RETRAITES'), ('Gestion des Carrières', 'GESTION_CARRIERES'), ('Finances', 'FINANCES'), ('Informatique et Organisation', 'INFORMATIQUE_ORGANISATION'), ('Administration Générales', 'ADMINISTRATION_GENERALES')], max_length=255)),
        ...
        migrations.AddField(
            model_name='demand',
            name='state',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mission.statedemand'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mission.employee'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mission.demand')),
                ('transit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mission.transition')),
